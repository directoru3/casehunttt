      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-2 bg-gradient-to-r from-blue-600/20 to-cyan-600/20 px-4 py-2 rounded-lg border border-blue-500/50">
            ...
            {onDepositClick && (
              <button
                ...
                className="bg-gradient-to-r from-yellow-600 to-orange-600 hover:from-yellow-700 hover:to-orange-700 text-white font-bold px-3 py-2 rounded-lg transition-all shadow-lg hover:shadow-yellow-500/50 flex items-center gap-1"
              >
                <Plus size={18} />
